      ...
      <div class="carousel-inner text-white ">
        <div class="carousel-item active">
            <div className='container-responsive'>
              <img class="d-block w-100" src="https://i.redd.it/n0j6ibnfxzey.png" alt='landing-image'/>
              </div>
        ...
        <div class="carousel-item align-items-center ">
          <div className='container-responsive'>
          <img class="d-block w-100"  id='funny-image' src="https://i.imgur.com/PK6HXUG.jpg" alt='landing-image'/>
          </div>
